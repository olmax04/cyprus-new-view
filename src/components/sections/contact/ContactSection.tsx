...
export default function ContactSection({ phone, email, address, t }: ContactSectionProps) {
  ...
  return (
    <section id="contact" className="relative py-16 md:py-24 lg:py-32 bg-[#0a0508] overflow-hidden">
      {/* Decorative background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#C5A059]/5 rounded-full blur-[160px]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-16 text-center">
        ...
        <AnimatedSection animation="fade-up" delay={450} duration={1}>
          <button
            ...
            className="group relative inline-flex items-center justify-center gap-3 px-12 md:px-16 py-4 border border-[#C5A059]/50 bg-[#1a0b10]/30 backdrop-blur-sm text-[#C5A059] hover:text-[#1a0b10] overflow-hidden transition-all duration-500"
            style={{ fontFamily: 'var(--font-serif)' }}
          >
        ...
        <AnimatedSection animation="fade" delay={600} duration={1.5}>
          <div className="mt-12 flex items-center justify-center gap-6">
            <div className="w-16 h-[1px] bg-gradient-to-r from-transparent to-[#C5A059]/30" />
            <div className="w-2 h-2 rotate-45 border border-[#C5A059]/30" />
            <div className="w-16 h-[1px] bg-gradient-to-l from-transparent to-[#C5A059]/30" />
          </div>
        </AnimatedSection>
      </div>
