...
export default function SearchBar({ search, searchButtonLabel }: SearchBarProps) {
  return (
    <div className="relative z-20 px-6 md:px-16 lg:px-24 pb-10">
      <div className="grid gap-3 md:grid-cols-[1.2fr_1.1fr_1fr_auto] items-center bg-[var(--color-bg-surface)]/50 backdrop-blur-md border border-[var(--color-accent)]/20 p-4 md:p-5">
